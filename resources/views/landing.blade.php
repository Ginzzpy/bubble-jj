...
<head>
    ...
    <!-- [Template CSS Files] -->
    <link rel="stylesheet" href="{{ asset('assets/css/landing/style.css') }}" id="main-style-link">
    <link rel="stylesheet" href="{{ asset('assets/css/landing/style-preset.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/css/landing/landing.css') }}">
                ...
                <div>
                    <div class="d-flex align-items-center gap-3">
                        @if (Auth::guard('viewer')->check())
                            <a class="text-white" href="{{ route('viewer.home') }}">
                                Home
                            </a>
                        @endif
                        <a class="btn btn-primary" href="{{ route('viewer-login') }}">
                            Daftar/Login
                        </a>
                    </div>
                </div>
            ...
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-9 col-xl-6">
                    ...
                    <div class="my-5">
                        ...
                        <a href="{{ route('viewer-login') }}" class="btn btn-primary">
                            Daftar/Login
                        </a>
                    </div>
                </div>
